...
export default class SignIn extends React.Component {
  ...
  componentDidMount() {
    ...
    schema
      ...
      .is()
      .not()
      .oneOf(["Passw0rd", "Password123", "12345678", "qwerty"]);
  ...
  render() {
    ...
    const isPasswordInvalid = this.state.schema
      ? !this.state.schema.validate(this.state.password)
      : true;
    ...
    return (
      <div className="SignInWrapper">
          ...
          <FormGroup row>
            ...
            <Col sm={10}>
              <Input
                ...
                name="email"
                id="email"
                invalid={this.state.email.length > 0 && isEmailInvalid}
          ...
          <FormGroup row>
            ...
            <Col sm={10}>
              <Input
                ...
                name="password"
                id="password"
                invalid={this.state.password.length > 0 && isPasswordInvalid}
        ...
        {this.state.signInError && (
          <div className="error-block"> {this.state.signInError} </div>
        )}
      </div>
    );
  }
